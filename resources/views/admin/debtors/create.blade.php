...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.debtor.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.debtors.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label class="required" for="file_number">{{ trans('cruds.debtor.fields.file_number') }}</label>
                <input class="form-control {{ $errors->has('file_number') ? 'is-invalid' : '' }}" type="text" name="file_number" id="file_number" value="{{ old('file_number', '') }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('debt_type') ? 'is-invalid' : '' }}" name="debt_type_id" id="debt_type_id" required>
                    @foreach($debt_types as $id => $debt_type)
                        <option value="{{ $id }}" {{ old('debt_type_id') == $id ? 'selected' : '' }}>{{ $debt_type }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('creditor') ? 'is-invalid' : '' }}" type="text" name="creditor" id="creditor" value="{{ old('creditor', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('arrear_period_start') ? 'is-invalid' : '' }}" type="text" name="arrear_period_start" id="arrear_period_start" value="{{ old('arrear_period_start') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('arrear_period_end') ? 'is-invalid' : '' }}" type="text" name="arrear_period_end" id="arrear_period_end" value="{{ old('arrear_period_end') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('initial_amount') ? 'is-invalid' : '' }}" type="number" name="initial_amount" id="initial_amount" value="{{ old('initial_amount', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('payments') ? 'is-invalid' : '' }}" type="number" name="payments" id="payments" value="{{ old('payments', '0') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('outstanding') ? 'is-invalid' : '' }}" type="number" name="outstanding" id="outstanding" value="{{ old('outstanding', '0') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('correspondence') ? 'is-invalid' : '' }}" type="text" name="correspondence" id="correspondence" value="{{ old('correspondence', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('charges') ? 'is-invalid' : '' }}" type="number" name="charges" id="charges" value="{{ old('charges', '') }}" step="0.01">

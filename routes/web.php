...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => ['auth', '2fa']], function () {
    ...
    // Debtors
    Route::delete('debtors/destroy', 'DebtorsController@massDestroy')->name('debtors.massDestroy');
    Route::post('debtors/media', 'DebtorsController@storeMedia')->name('debtors.storeMedia');
    Route::post('debtors/ckmedia', 'DebtorsController@storeCKEditorImages')->name('debtors.storeCKEditorImages');
    Route::post('debtors/parse-csv-import', 'DebtorsController@parseCsvImport')->name('debtors.parseCsvImport');
    Route::post('debtors/process-csv-import', 'DebtorsController@processCsvImport')->name('debtors.processCsvImport');
